...
import { getRecommendedVideos } from '../store/reducer/getRecommnendVideos';
import { getVideoDetails } from '../store/reducer/getVideosDetails';
...
const Watch = () => {
    ...
    const recommendVideos = useAppSelector((state) => state.youtubeApp.recommendedVideos);
