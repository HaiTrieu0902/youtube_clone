...
import { changeSearchTerm, clearSearchTerm, clearVideo } from '../store/youtube.slice';
...
const Navbar = () => {
    ...
    const searchItems = useAppSelector((state: RootState) => state.youtubeApp.searchItem);
    const handleSearch = () => {
                    ...
                    <div className="flex bg-zinc-900 items-center h-10 px-4 pr-0">
                        <div className="flex gap-4 items-center pr-5">
                            ...
                            <AiOutlineClose
                                ...
                                className={`text-xl cursor-pointer  ${!searchItems ? 'invisible' : 'visible'} `}
                            />
                        </div>
